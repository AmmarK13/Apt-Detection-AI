...
# Load dataset
df = pd.read_csv("UNSW_NB15/cleaned_data/testing_dups_removed.csv")
...
df_cleaned.to_csv("UNSW_NB15/cleaned_data/testing_dataLeakage.csv", index=False)
print("Cleaned dataset saved as 'testing_dataLeakage.csv'")