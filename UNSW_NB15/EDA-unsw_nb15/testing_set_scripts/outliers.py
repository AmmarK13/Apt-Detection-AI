...
df = pd.read_csv("UNSW_NB15/cleaned_data/testing_dataLeakage.csv")
...
# Compare results
skew_comparison = pd.DataFrame({"before Log Transform": skew_before, "After Log Transform": skew_after})
...
output_path = "UNSW_NB15/cleaned_data/testing_outliers.csv"
