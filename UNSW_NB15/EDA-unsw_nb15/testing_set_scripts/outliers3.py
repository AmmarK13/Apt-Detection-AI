...
# sanity check 3 for outliers performing after encoding
...
df = pd.read_csv("UNSW_NB15/cleaned_data/testing_encoded.csv")
...
# SAVE FILE
df_cleaned.to_csv("UNSW_NB15/cleaned_data/testing_outliers_final.csv", index=False)
