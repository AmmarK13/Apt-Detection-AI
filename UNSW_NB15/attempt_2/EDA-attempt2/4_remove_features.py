...
file_path = "UNSW_NB15/cleaned_attempt2/2_normalised_data.csv" 
...
# df_balanced.to_csv('UNSW_NB15/cleaned_attempt2/3_remove_features.csv' , index=False)
# print("Saved cleaned and balanced dataset as 3_remove_features")
